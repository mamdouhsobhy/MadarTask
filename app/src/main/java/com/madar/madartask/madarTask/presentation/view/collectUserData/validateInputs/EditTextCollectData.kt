package com.madar.madartask.madarTask.presentation.view.collectUserData.validateInputs
...
import com.madar.madartask.madarTask.presentation.view.collectUserData.FragmentCollectUserData

fun FragmentCollectUserData.initEditTextCollectData() = with(binding) {
...
fun FragmentCollectUserData.validateCollectData(): Boolean =
    with(binding) {
